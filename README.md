...
Az Marina is part of the Az-Framework Summer 2.0 activity pack. It registers with Az-Summer2Core for contracts, routing, validation, rewards, and dispatch hooks.
